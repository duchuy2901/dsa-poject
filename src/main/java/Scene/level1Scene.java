...
public class level1Scene extends Scene {
	...
	private void setUpLevel1() {
		player= new Player(gp, keyH,enemies,true);
		setUpEnemy();
	...
	private void setUpEnemy() {
		enemies.add(new SkeletonEnemy(gp,player,keyH,47,17,3,5,100,20));
		enemies.add(new SkeletonEnemy(gp,player, keyH,50,13,3,5,100,30));
		enemies.add(new SkeletonEnemy(gp,player, keyH,63,17,3,5,100,20));
		enemies.add(new SkeletonEnemy(gp,player, keyH,45,31,8,8,150,20));
	}
